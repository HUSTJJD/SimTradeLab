...
- Sell orders for delisted holdings fall back to the last close price when the current date is past the stock's final trading day; buy orders keep returning None.
